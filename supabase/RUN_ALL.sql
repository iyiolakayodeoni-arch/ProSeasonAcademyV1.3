...
-- NOTE: this needs the `waitlist`, `profiles` and `config` tables, which
-- schema.sql creates. If you have not run schema.sql on this database yet,
-- run it FIRST, on its own, then come back to this file.
