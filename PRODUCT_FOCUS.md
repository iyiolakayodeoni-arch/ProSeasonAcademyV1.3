...
It is not primarily a news app, a social network, a card generator, a stats dashboard, or a collection of game mechanics. Those can support the practice, but they are not the product.

## The only loop that matters

1. **Play** a real console match.
...
> Does this help a player play, review, or carry one lesson forward?

If no, it should be cut, folded into an existing utility, or kept outside the member app.
